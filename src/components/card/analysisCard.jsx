...
const AnalysisCard = () => {
  ...
  return (
    <div className="w-[98%] mx-auto sm:w-[95%] h-full mb-[22rem] sm:mb-[16rem]  md:mb-[12rem] xl:mb-[2rem]">
      <div className=" w-full grid gap-3 md:gap-10 xl:gap-20 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 items-center h-[100px] p-3">
        <div className="w-full flex items-center justify-center sm:justify-start space-x-2 h-full px-4 py-2">
          <div className="flex items-center space-x-2 ">
            <div className="w-fit h-fit rounded-lg p-2 sm:p-3 bg-[#51CBFF] bg-opacity-20 flex items-center justify-center">
        ...
        <div className="w-full flex items-center justify-center sm:justify-start space-x-2  h-full p-4">
          <div className="flex items-center space-x-2 ">
            <div className="w-fit h-fit rounded-lg p-2 sm:p-3 bg-[#FD1F9B] bg-opacity-20 flex items-center justify-center">
